...
Key Learnings:
- Stable generative systems require separation between layout logic and media rendering logic.
- Collision negotiation is highly sensitive to spacing cadence (rowStep) and allowable placement opportunities.
- Increased rhythm constraints reduce entropy but expose the underlying grid system more visibly.
- Organic behavior emerges not from randomness, but from constrained negotiation density.
- Deterministic systems can still approximate organic behavior when the governing rules allow enough spatial freedom.

Current State:
✅ Stable rendering
✅ CMS media integrated
✅ Portrait logic functioning
✅ No card collisions
✅ Protected production V1
✅ Sandbox workflow established
